...
When the incoming wind increases its speed, then the \acrshort{AOA} decreases reducing the lift \texit{l} and increasing the drag \textit{d}, leading to a lower tangential load, which is given by:
\begin{equation}
