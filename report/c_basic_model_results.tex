...
\begin{figure}[!htbp]
  ...
  \caption{Rotor power maximization simulation number I: WS ramp from 4 to 10 $\si{\meter\per\second}$ }
...
\begin{figure}[!htbp]
  ...
  \caption{Rotor power maximization simulation number II: WS ramp from 10 to 14 $\si{\meter\per\second}$ }
...
\begin{figure}[!htbp]
  ...
  \caption{Rotor power maximization simulation number III: WS ramp from 14 to 20 $\si{\meter\per\second}$ }
