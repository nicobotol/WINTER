...
In \autoref{fig:fig_cP_cT_comp} it is possible to see a great difference between the results below 7 $\left[\si{\meter \per \second}\right]$. To understand this behaviour, a further explanation about the vibration of the \acrshort{WT} is required. In general, the rotation of the rotor excites the tower at frequencies multiple of 3P, with \begin{equation}
