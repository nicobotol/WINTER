...
\begin{frame}{Scope of thesis}
  ...
  \note{
    \begin{itemize}
      \item What I have included on the model and some limitations of the scope
      \item Talk briefly about the different control strategies implemented. Maybe introduce here the so called MPPT: change the behavior of the turbine to convert the maximum amount of energy while the  environmental condition (i.e. wind speed) changes
      \item Use of the blade pitch for controlling the rotational speed
    \end{itemize}
  }
\end{frame}
...
\begin{frame}{Pitch controller}
  ...
  \note{Saturation necessary to avoid pitching action before the reaching of the rated rotational speed}
\end{frame}
