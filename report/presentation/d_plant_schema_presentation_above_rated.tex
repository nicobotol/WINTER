...
\begin{tikzpicture}[auto, node distance=2.5cm,>=latex',centered=left]
  ...
  \node [style=block_dashed, align=center] (6) at (2.5, -4.75) {Power \\ controller};
  \node [style=block_green, align=center] (24) at (6.25, -4.75) {Current \\ controller};
  ...
  \draw [->] (25) |- node {} (6.160);
  \draw [->] (21) |- node {} (6.180);
  \draw [->] (6) -- node[align=center] {\redbold{$T_G^*$= }\\ \redbold{const.}} (24);
  \draw [->] (24) -- node {$U_q^*$ } (7);
