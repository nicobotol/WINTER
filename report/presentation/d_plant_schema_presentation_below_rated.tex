...
\tikzstyle{block_skyblue} = [draw, fill=coral, rectangle, minimum height=2.5em, minimum width=3em]
\tikzstyle{block_yellow} = [draw, fill=paleyellow, rectangle, minimum height=2.5em, minimum width=3em]
\tikzstyle{block_green} = [draw, fill=mintgreen, rectangle, minimum height=2.5em, minimum width=3em]
\tikzstyle{block_magenta} = [draw, fill=lavender, rectangle, minimum height=2.5em, minimum width=3em]
...
\begin{tikzpicture}[auto, node distance=2.5cm,>=latex',centered=left]
  ...
  \node [style=block_dashed, align=center] (4) at (6, -2.5) {Pitch \\ controller};
  % \node [style=block_yellow, align=center] (5) at (9, -2.5) {Pitch \\ actuator};
  \node [style=block_green, align=center] (6) at (3, -4.75) {Power \\ controller};
  \node [style=block_green, align=center] (24) at (6, -4.75) {Current \\ controller};
  \node [style=block_green, align=center] (7) at (9, -4.75) {Generator \\ (PMSM)};
  \node [style=block_dashed, align=center] (8) at (12.5, -4.75) {Power \\electronics};
  ...
  \node [dot=1pt] (18) at (10.5, -4.75) {};
  \node [dot=1pt] (19) at (4.5, -0.75) {};
  \node [dot=1pt] (20) at (9, -5.75) {};
  \node [dot=1pt] (21) at (1.25, -5.75) {};
  \node [dot=1pt] (22) at (9.9, -4.5) {};
  \node [dot=1pt] (23) at (10.5, -4.5) {};
  \node [dot=1pt] (25) at (1.25, -3.5) {};
  \node [dot=1pt] (26) at (2.4, 0.35) {};
  \node [dot=1pt] (27) at (5.22, 0.35) {};
  \node [dot=1pt] (28) at (3.6, 0.35) {};
  ...
  % \draw [-] (5) -| node {} (14);
  \draw [-] (4) -| node {} (14);
  \draw [-] (15) -- node {\redbold{$\theta$=constant}} (14);
  \draw [->] (15) |- node {} (1.200);
  \draw [-] (17) |- node {} (25);
  \draw [->] (25) |- node {} (6.160);
  \draw [->] (21) |- node {} (6.180);
