...
\autoref{fig:gain_scheduling_time_dependency} reports the time evolution of the pitch angle, rotor rotational speed, and the generator torque. In particular data from three different simulations are reported. The first is run with the gain scheduling discussed in the subsection \ref{subsec:gain_schdeuling_DTU10MW}, the second with the constant gains here chosen, and the third with the the gain schdeuling reported by \cite{Olimpo_Anaya‐Lara}.
\begin{figure}[htb]
  \begin{subfigure}{0.5\columnwidth}
    \centering
    \includegraphics[width = \columnwidth]{images/vectorial/2023_05_9_20_55_30fig_wind_TS.eps}
  ...
  \begin{subfigure}{0.5\columnwidth}
    \centering
    \includegraphics[width = \columnwidth]{images/vectorial/2023_05_9_20_55_37fig_pitch_dynamic.eps}
  ...
  \begin{subfigure}{0.5\columnwidth}
    \centering
    \includegraphics[width = \columnwidth]{images/vectorial/2023_05_9_20_55_46fig_omega_dynamic.eps}
  ...
  \begin{subfigure}{0.5\columnwidth}
    \centering
    \includegraphics[width = \columnwidth]{images/vectorial/2023_05_9_20_56_15fig_torque_dynamic.eps}
  ...
  \begin{subfigure}{0.5\columnwidth}
    \centering
    \includegraphics[width = \columnwidth]{images/vectorial/2023_05_9_20_55_59fig_power_dynamic.eps}
