...
To study the problem, a numerical approach is followed. First of all, a vector of windspeed, pitch angle, and rotational speed are defied. Then, for each wind speed, the power produced for each combinations of rotational speed and pitch is computed and the maximum among then is extracted. At this point the corresponding $\lambda$ and $\theta$ are extracted and can be analysed, as done in \autoref{fig:parameters_for_below_rated}.
\begin{figure}[htb]
  \begin{subfigure}{0.5\textwidth}
    \centering
    \includegraphics[width=\textwidth]{images/vectorial/2023_06_24_15_57_04fig_pitch_GE.eps}
    \caption{Optimal pitch angle}
    \label{fig:2023_06_24_15_57_04fig_pitch_GE}
  \end{subfigure}
  \begin{subfigure}{0.5\textwidth}
    \centering
    \includegraphics[width=\textwidth]{images/vectorial/2023_06_24_15_57_04fig_lambda_GE.eps}
    \caption{Tip speed ratio}
    \label{fig:2023_06_24_15_57_04fig_lambda_GE}
  \end{subfigure}
  \begin{subfigure}{0.5\textwidth}
    \centering
    \includegraphics[width=\textwidth]{images/vectorial/2023_06_24_15_57_04fig_cP_GE.eps}
    \caption{Power coefficient}
    \label{fig:2023_06_24_15_57_04fig_cP_GE}
  \end{subfigure}
  \caption{Comparison of the most important parameters for the operation below rated wind speed, where \textit{rotor} are quantities referred to the quantities identified basing on the rotor input power and \textit{generator} are the ones referred to the generator electrical power.}
  \label{fig:parameters_for_below_rated}
\end{figure}

In particular, the pitch angle is constant and could be considered as 0 $\mesunt{\degree}$. The tip speed ratio and the $c_P$ show some variability due to the discretization done in the choice of the vectors, but in general they can be assumed as constant and equal to they means. \\
This result is quite interesting because it allow us to use the same approach used in \ref{eq:T_G2} to control the turbine even in this case. 
