...
\subsubsection[Below rated WS]{Generator's torque reference below rated WS}\label{subsec:below_rotor}
...
\subsubsection[Above WS]{Generator's torque reference above rated WS}
...
\subsubsection[Below rated WS]{Generator's torque reference below rated WS}
...
\subsubsection[Above rated WS]{Generator's torque reference above WS}
