...
\begin{center}
	\begin{tabular}{c|cccc}
		...
		& Norm. speed where the pitch controller gains are doubled & $\Omega_{2,ratio}$ & & \cite{DTU_Wind_Energy_E_0028} pag.14\\ 
		&Coeff. linear term in aero scheduling & K1=164.13 & & \cite{DTU_Wind_Energy_E_0028} pag.14\\
		&Coeff. quadratic term in aero scheduling & K2=702.09 & & \cite{DTU_Wind_Energy_E_0028} pag.14\\
