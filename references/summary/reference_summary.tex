...
\begin{center}
	\begin{tabular}{c|cccc}
		Rotor & Inertia &  & $\left[\si{\kilo \gram \meter \square}\right]$ & \\ 
		...
		& Poles & 320 & & \cite{10-MW_Direct-Drive_PMSG-Based_Wind_Energy_Conversion_System_Model} \\
		...
		& stator resistance & 64 & $\left[ \si{\ohm}\right]$ & \cite{10-MW_Direct-Drive_PMSG-Based_Wind_Energy_Conversion_System_Model}\\
