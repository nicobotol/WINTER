function plot_parametrization(plot_name,out_cell,series,x_my_ref, ...
  y_my_ref,x_label,y_label,plot_title,my_scaling,date)
...
plot(x_my_ref, y_my_ref/my_scaling, '.-', 'LineWidth', line_width, ...
