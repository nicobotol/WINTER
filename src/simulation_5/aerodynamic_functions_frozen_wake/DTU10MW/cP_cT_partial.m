function [cp_partial, cT_partial, pt, pn, a_store, a_prime_store] = cP_cT_partial(r_item_no_tip, r_vector, ...
...
a_store = zeros(1, r_item_no_tip);
a_prime_store = zeros(1, r_item_no_tip);
