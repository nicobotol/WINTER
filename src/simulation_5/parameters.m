...
simulation.post_process_time = 995*ones(10,1); % time from the end of the simulation in which to perform the post processing 
% Rotor parameters
...
IMM_scale = [0.8, 1, 1.2];
IMM.rho_vector = IMM_scale*rho;
IMM.K_vector = IMM_scale*generator.K_opt_GE;
...
IMM.measure_len = 2;           % number of measures
IMM.prob_transition = 0.985; % probability of transition
if IMM.n_models > 1
