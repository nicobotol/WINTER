...
P_GE = -Rs*(A*cp*rho*V0^3 - 2*B*lambda^2*V0^2/R^2)^2*R^2/(9*lambda^2*V0^2*p^2*Lambda^2) + (-B*lambda*V0/R + A*cp*rho*V0^2*R/(2*lambda))*lambda*V0/R; % [W] generator electrical power
