function [rotor, generator, blade, T_R0, omega_rated_GE, IMM] = run_Kopt_KoptGE(rho, lambda_vector, pitch_vector, lookup_cP, rotor, blade, generator, gearbox, V0_0, rated_values, rated_values_P_GE, lookup_Pitch, lookup_pitch_P_GE, simulation,IMM, i)
