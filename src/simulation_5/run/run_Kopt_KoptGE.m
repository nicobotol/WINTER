function [rotor, generator, blade, T_R0, omega_rated_GE] = run_Kopt_KoptGE(rho, lambda_vector, pitch_vector, lookup_cP, rotor, blade, generator, gearbox, V0_0, rated_values, rated_values_P_GE, lookup_Pitch, lookup_pitch_P_GE, simulation, i)
  ...
  if rem(i, 2) == 1 % case of K_opt based on generator
    ...
    [rotor, generator, blade, T_R0] = initial_conditions_GE(rho, lambda_vector, pitch_vector, lookup_cP, rotor, blade, generator, gearbox, V0_0, V0_rated, rated_values_P_GE, lookup_pitch_P_GE);
